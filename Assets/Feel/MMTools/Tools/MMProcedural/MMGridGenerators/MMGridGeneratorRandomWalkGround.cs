...
namespace MoreMountains.Tools
{
    ...
    public class MMGridGeneratorRandomWalkGround : MMGridGenerator
    {
        ...
        /// <returns></returns>
        public static int[,] Generate(int width, int height, int seed, int minHeightDifference, int maxHeightDifference, int minFlatDistance, int maxFlatDistance)
        {
            ...
            int groundHeight = Random.Range(0, height);
            ...
            for (int i = 0; i < width; i++)
            {
                ...
                if (currentFlatDistance >= flatDistance - 1)
                {
                    ...
                    groundHeight = Mathf.Clamp(groundHeight, 1, height - 1);
